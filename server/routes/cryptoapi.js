        ...
        return new Promise((resolve, reject) => {
          axios.get(baseURL)
            .then(function(response) {
                ...
                if (objectTrends && Object.keys(objectTrends).length >0) {
                    ...
                    return resolve(priceTrends.reverse());
                } else {
...
var CryptoPriceCurrentAPI = {
    runQuery: function(tickerSymbol = 'BTC') {
        ...
        const APIKey = config.cyrptoTrendsAPI;
        const baseURL = 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_INTRADAY&symbol=' + tickerSymbol.toLowerCase() + '&market=USD&apikey=' + APIKey;
                console.log('tickerbaseURL', baseURL);
        ...
        return new Promise((resolve, reject) => {
          axios.get(baseURL)
            .then(function(response) {
                ...
                if (objectCurrent && Object.keys(objectCurrent).length > 0) {
